...
<body class="g-sidenav-show bg-gray-200">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-danger" id="sidenav-main">
    <div>
      ...
      <a class="navbar center pt-2 pl-5" href="index">
        <img src="<?= site_url('asset/backend/assets/img/logo.png'); ?>" alt="main_logo">
        <span class="text-xs text-light center pl-3">Cargo and Delivery system</span>
      </a>
    </div>
        ...
        <hr class="horizontal light mt-0 mb-2">
            <div class="col-14">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white<?= ($navlink === 'beranda') ? 'active bg-gradient-info' : ''; ?>" href="<?= site_url('driver/index'); ?>">
                    ...
                    <li class="nav-item navbar-expand-xs">
                        <a class="nav-link text-white<?= ($navlink === 'shipping') ? 'active bg-gradient-info' : ''; ?>" href="<?= site_url('driver/shipping'); ?>">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li class="nav-item navbar-expand-xs">
                        <a class="nav-link text-white<?= ($navlink === 'report') ? 'active bg-gradient-info' : ''; ?>" href="<?= site_url('driver/report'); ?>">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid">
            <div class="copyright float-right pt-5 text-sm">
                ...
                | Cargo and Delivery System by <a href="https://github.com/mrezadit"><b>mrezadit </b></a>
            </div>
        </div>
    </footer>
  <!--   Core JS Files   -->
