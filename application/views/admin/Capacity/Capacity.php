<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Cargo Capacity</h6>
            </nav>
    ...
    <div class="card-header p-0 w-75 position-fixed mt-n4 mx-2 z-index-2">
        <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
            <div class="col-8 d-flex align-items-center"> 
                <i class="material-icons pr-3">apps</i>
                <h6 class="mb-0">Cargo Capacity</h6>
            </div>           
            <div class="col-4 text-end">
                <a href="<?= site_url('admin/capacity/addcapacity'); ?>" class="btn btn-info btn-sm mb-0">Add Cargo</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                    ...
                    <?php if (!empty($capacity)) : $i = 1; foreach (array_reverse($capacity) as $value) : ?>
                        ...
                        <td class="pl-4">
                        <?php if ( $value->cstatus <= 1) :?>
                            <a href="<?= site_url('admin/capacity/'.$value->id_capacity.'/view'); ?>" rel="tooltip" title="detail" class="badge btn-dark btn-sm">
                            Details</a>
                        <?php elseif ( $value->cstatus == 2)  : ?>
                        <span class="text-xs font-weight-bold text-info">Processed</span>    
                        <?php else : ?>
                            <span class="text-xs font-weight-bold text-success">Completed</span>
                        </td>
                        <?php endif ;?> 
                        </td>
                        </tr>
