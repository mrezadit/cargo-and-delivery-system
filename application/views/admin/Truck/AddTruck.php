<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Add Truck Data</h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0">Create Truck Data</h4>
                    <span class="text-sm mb-0 text-end">Form to create a new truck data</span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                    <form class="pt-4" action="<?= site_url('admin/addTruck'); ?>" method="post">
                        <div class="row d-flex">
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                <label class="form-label"></label>
                                <input type="text" name="no_plate" class="form-control">
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                <label class="form-label"></label>
                                <input type="number" name="bmax" class="form-control"> kg
                            </div>
                            </div>
                            <div class="col-5 pl-3">
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                <label class="form-label"></label>
                                <input type="number" name="capacity" class="form-control"> m&sup3
                            </div>
                            </div>
                        </div>
                    </div>
