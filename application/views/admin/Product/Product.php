        ...
        <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
            <div class="col-8 d-flex align-items-center"> 
                    <i class="material-icons pr-3">task</i>
                      <h6 class="mb-0">Products Volume</h6>
            </div>
            <div class="col-4 text-end">
                <a href="<?= site_url('admin/product/addproduct'); ?>" class="btn btn-info btn-sm mb-0" title="Add Customers">Add Product</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                    ...
                    <tbody class="pl-3">
                    <?php if (!empty($product)) : $i = 1; foreach (array_reverse($product) as $value) : ?>
                        <tr>
                        <td>
                        ...
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold"><?= $value->berat; ?> Kg</span>
                        </td>
                        <td class="pl-4">
                            <span class="text-sm font-weight-bold">P : <?= $value->panjang;?>cm, T : <?= $value->tinggi;?>cm, L : <?= $value->lebar;?>cm</span>
                        </td>
                        <td class="pl-4">
                        <a href="<?= site_url('admin/product/'.$value->id_product.'/update'); ?>" rel="tooltip" title="delete" class="text-sm font-weight-bold text-info">
                        <i class="material-icons text-sm">edit</i> Edit </a>
                        <a href="<?= site_url('admin/deleteproduct/'.$value->id_product.''); ?>" rel="tooltip" title="delete" class="text-sm font-weight-bold text-danger">
