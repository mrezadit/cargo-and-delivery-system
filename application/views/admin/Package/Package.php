        ...
        <div class="card">
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Ruote Point</th>
                ...
                <?php if (!empty($package)) : $i = 1; foreach (array_reverse($package) as $value) : ?> 
                    ...
                    <td>
                        <span class="text-sm font-weight-bold "><?= $value->no_package; ?></span>
                    </td>
                    <td>
                        <span class="text-sm font-weight-bold "><?= $value->customer_name; ?></span>
                    </td>
                    <td>
                        <span class="text-sm font-weight-bold "><?= $value->phone; ?></span>
                    </td>
                    <td>
                        <span class="text-sm font-weight-bold "><?= $value->kota; ?></span>
                    </td>
                    <td>
                        <span class="text-sm font-weight-bold "><?= $value->t_kg; ?> kg</span>
                    </td>
                    <td>
                        <span class="text-sm font-weight-bold "><?= substr($value->t_kgv, 0, 5); ?> m&sup3</span>
                    </td>
                    <td>
                    ...
                    <?php elseif ( $value->pstatus == 4) : ?>
                        <span class="text-xs font-weight-bold text-success">Terkirim</span>
                    <?php else : ?>
                        <span class="text-xs font-weight-bold text-info">Loaded</span>
                    </td>
                    <?php endif ;?> 
                    </tr>
