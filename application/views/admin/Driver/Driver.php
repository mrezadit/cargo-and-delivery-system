<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Driver</h6>
            </nav>
        ...
        <div class="shadow-dark border-radius-lg d-flex px-5 pt-4 pb-3">
            <div class="col-8 d-flex align-items-center"> 
                    <i class="material-icons pr-3">task</i>
                      <h6 class="mb-0">Driver Data</h6>
            </div>
            <div class="col-4 text-end">
                <a href="<?= site_url('admin/driver/adddriver'); ?>" class="btn btn-info btn-sm mb-0" title="Add Driver">Add Driver</a>
            </div>
        </div>
    </div>
</div>
