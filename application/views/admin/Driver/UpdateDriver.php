<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Add Driver Data</h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0">Update Driver Data</h4>
                    <span class="text-sm mb-0 text-end">Form to update a new driver data</span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                    <form class="pt-4" action="<?= site_url('admin/updateDriver'); ?>" method="post">
                        <div class="row d-flex">
                            <div class="col-6">
                            <span>Driver</span></br>
                            <div class="input-group input-group-dynamic mb-4">
                                <label class="form-label"></label>
                                <input type="hidden" name="id_driver" value="<?= $detail['id_driver']; ?>">
                                <input type="text" name="driver" value="<?= $detail['driver']?>" class="form-control">
                            </div>
                            </div>
                        </div>
